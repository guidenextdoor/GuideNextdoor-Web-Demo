...
export default function PrivacyView() {
  ...
  const sections = [1, 2, 3, 4, 5, 6, 7].map(num => ({
    title: t(`legal.privacySections.${num}.title`),
    content: t(`legal.privacySections.${num}.content`)
  }));

  return (
    <>
      <Helmet>
        <title>{t('legal.privacyTitle')} - GuideNextdoor</title>
